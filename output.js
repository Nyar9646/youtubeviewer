/**
 * 【不要ファイル。勉強用】
 * babel のみでトランスパイルした結果
 * require の中身は output に含まれないため、実装時に動かなくなる
 *  ⇨ webpack で require 先を読み込み、bundle する
 */
"use strict";
...
var _jsxFileName = "/Users/kudoureina/pro/react/youtubeviewer/src/entries/sample.jsx";
